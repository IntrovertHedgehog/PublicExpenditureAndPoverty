...
Both the Ridge regression and LASSO regression models exhibit similar result metrics (MSE, MAE, MAPE, R^2). This result is expected. 
...
The comparison between the three models suggests that `country.code` affects the models generated in a significant way. 