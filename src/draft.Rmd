...
## 3.1. Use Complete Cases (Imtiyaaz
###  3.1.1. Model Fitting
###  3.1.2. Assessment
###  3.1.3. Interpretation

## 3.2. Selectively remove variables with high missing rate (Callista)
###  3.2.1. Model Fitting
###  3.2.2. Assessment
###  3.2.3. Interpretation

## 3.3. Update the data set as we select variables (Isaac)
###  3.3.1. Model Fitting 
```{r}
...
gdp per capital, income class and region of the country can provide a model to predict the poverty headcount ratio in a country.
...
Guinea is an interesting point. Because the outlier data (87.9% in 1991) is quite different to the next data point (40.8% in 1994), a huge jump in just 3 years. 
