...
2.  **Step-by-step remove frequently missing variables**: The same as we did before, but this process should be carried out carefully as we run the chance of dropping an important variable.
